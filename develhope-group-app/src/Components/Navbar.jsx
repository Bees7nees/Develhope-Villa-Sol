      ...
      <nav className={style.navbar}>
        <Link to="/">
          <img
            ...
            src="/src/Assets/svg/logoBlack.svg"
            alt="logo"
          />
        </Link>
        <ul className={style.navTopContainer}>
          ...
          <li>
            <Link className={style.navLinks} to="/nosotros">
              NOSOTROS
            </Link>
          </li>
          <li>
            <Link className={style.navLinks} to="/habitaciones">
              HABITACIONES
            </Link>
          </li>
          ...
          <li>
            <Link
              onClick={handleRestauranteClick}
              className={style.navLinks}
              to="/restauranteSunset"
            >
              RESTAURANTES
            </Link>
          </li>
          {verRestauranteSubNav && (
            <nav className={classes.subNavContenedor}>
              <ul className={classes.listContainer}>
                <li>
                  <Anchor className={style.navLinks} smooth={true} to="#menu">
                    MENÚ
                  </Anchor>
                </li>
                ...
                <li className={style.navLinks}>
                  ...
                  >
                    ...
                    >
                      <path
                        d="M1.89661 0.0177656L7.59471 4.95853L13.359 0.0598974L15.1133 1.58096L7.57812 7.99845L0.113354 1.52583L1.89661 0.0177656Z"
                        fill="#213242"
                      />
                    </svg>
                  </div>
                  {verDropdown && (
                    <div className={classes.dropdown}>
                      <Link className={classes.sublink} to="/restauranteSunset">
                        Sunset
                        <span className={classes.subtext}>
                          Gastronomía Andaluza
                        </span>
                      </Link>
                      <Link className={classes.sublink} to="/restauranteBuffet">
                        Buffet
                        <span className={classes.subtext}>
                          Gastronomía Continental
                        </span>
                      </Link>
                      <Link
                        className={classes.sublink}
                        to="/restauranteSunrise"
                      >
                        Sunrise
                        <span className={classes.subtext}>
          ...
          {verSpaSubNav && (
            <nav className={classes.subNavContenedor}>
              <ul className={classes.listContainer}>
                <li>
                  <Link className={style.navLinks} to="#tratamientos">
                    TRATAMIENTOS
                  </Link>
                </li>
                <span className={classes.divisor}></span>
                ...
                <span className={classes.divisor}></span>
                <li>
                  <Link className={style.navLinks} to="#barraReservas">
                    RESERVAR
                  </Link>
                </li>
              </ul>
          ...
          <li>
            <Link className={style.navLinks} to="/galeria">
              GALERÍA
            </Link>
          </li>
          <li>
            <Anchor className={style.navLinks} smooth={true} to="#contacto">
              CONTACTO
            </Anchor>
          </li>

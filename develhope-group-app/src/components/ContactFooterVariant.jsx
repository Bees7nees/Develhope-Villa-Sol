      ...
      <div className={classes["contact-footer-variants"]}>
        <div className={classes["header-section"]}>
          ...
          <div className={classes["description"]}>
            We are always looking to improve. Your feedback is super helpful to
            us.
          </div>
        </div>
        <div className={classes["input-section"]}>
          <div className={classes["rectangle-9"]}></div>
          <div className={classes["mail-content"]}>
            <div className={classes["email"]}>
              <div className={classes["rectangle-801"]}></div>
              <svg
        ...
        <div className={classes["submit-button"]}>
          <div className={classes["write-message"]}>Write message</div>
        </div>
      </div>
  );
}

...
export function ContactFooterVariant() {
  return (
    <div className={classes["contact-footer-variants"]}>
      ...
      <section className={classes["input-section"]}>
        <form className={classes["mail-content"]}>
          ...
          <input type="text" className={classes["placeholder"]} placeholder="Email"></input>
        </form>
        <form className={classes["user-content"]}>
          ...
          <input type="text" className={classes["placeholder"]} placeholder="Name"></input>
        </form>
      </section>
      <section className={classes["submit-button"]}>
        <button type="button" className={classes["write-message"]}>
          Write message
        </button>
      </section>
    </div>

...
const PrevArrow = ({ onClick }) => (
  <div onClick={onClick}>
    <img className={styles.customPrevArrow} src="../../assets/pre-arrow_rooms.png" />
  </div>
);

const NextArrow = ({ onClick }) => (
  <div onClick={onClick}>
        <img className={styles.customNextArrow} src="../../assets/post-arrow_rooms.png" />
  </div>
);
...
export default function CarrouselRooms(){
  ...
  return (
    ...
    <div className={styles.slideItem}>
        <img src="../../assets/Room_Standar.jpg" alt="Habitación estándar" width={1440} height={800} className={styles.imgCarrouselRoom}/>
        <TitleCarrouselRooms text="HABITACION ESTÁNDAR" />
      </div>
      <div className={styles.slideItem}>
        <img src="../../assets/Room_Premium.jpg" alt="Habitación Premium" width={1440} height={800} className={styles.imgCarrouselRoom}/>
        <TitleCarrouselRooms text="HABITACIÓN PREMIUM" />
      </div>
      <div className={styles.slideItem}>
        <img src="../../assets/Room_Suite.png" alt="Habitación Suite" width={1440} height={800} className={styles.imgCarrouselRoom}/>
